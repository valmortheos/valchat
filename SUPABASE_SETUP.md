...
Jalankan script ini di menu **SQL Editor**. Script ini sudah melengkapi tabel `read_receipts` dan `deleted_messages`.

```sql
-- 1. Bersihkan Trigger Lama (Opsional, untuk mencegah konflik)
...
-- 4. Tabel Read Receipts (Tanda Dibaca / Centang Biru)
...
-- 5. Tabel Deleted Messages (Hapus untuk Saya)
